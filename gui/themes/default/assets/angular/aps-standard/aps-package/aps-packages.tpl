<div class="ApsPackageList" data-ng-cloak>
	<div data-ng-controller="ApsPackage as PkgCtrl">
		<table data-ng-table="PkgCtrl.tableParams" data-template-header="custom/header"
			...
			<tr data-ng-repeat-start="package in $data">
				...
				<td class="Details" data-ng-class="{ 'Locked': package.status == 'locked' }" data-filter="{search: 'custom/filters/globalsearch'}">
			...
			<tr data-ng-repeat-end>
				...
				<td class="Details">
					...
					<!-- EDP: adm_btn1 -->
					<!-- BDP: client_btn1 -->
					<div ng-controller="NewApsInstance as NewApsInstanceCtrl">
						<jq-button data-ng-click="NewApsInstanceCtrl.newInstanceModal(package)" value="<?= tohtml(tr('Install'))?>"></jq-button>
					</div>
					<!-- EDP: client_btn1 -->
				</td>
			</tr>
