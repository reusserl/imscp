 ...
 */
class ApsInstance extends \iMSCP\ApsStandard\Entity\ApsInstance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'iMSCP\\ApsStandard\\Entity\\ApsInstance' . "\0" . 'id', '' . "\0" . 'iMSCP\\ApsStandard\\Entity\\ApsInstance' . "\0" . 'package', '' . "\0" . 'iMSCP\\ApsStandard\\Entity\\ApsInstance' . "\0" . 'owner', '' . "\0" . 'iMSCP\\ApsStandard\\Entity\\ApsInstance' . "\0" . 'settings', '' . "\0" . 'iMSCP\\ApsStandard\\Entity\\ApsInstance' . "\0" . 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ApsInstance $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPackage(\iMSCP\ApsStandard\Entity\ApsPackage $package = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setOwner(\iMSCP\Entity\Admin $owner = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function addSetting(\iMSCP\ApsStandard\Entity\ApsInstanceSetting $setting)
    {
    ...
    public function hasSetting($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasSetting', array($name));
