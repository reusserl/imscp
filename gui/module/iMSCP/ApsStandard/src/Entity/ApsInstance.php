...
class ApsInstance
{
	 ...
	 * @ORM\ManyToOne(targetEntity="iMSCP\Entity\Admin", cascade={"merge"})
	 * @ORM\JoinColumns({
	 *   @ORM\JoinColumn(name="owner_id", referencedColumnName="admin_id", nullable=false, onDelete="CASCADE")
	 * })
	 * @Assert\NotNull(message="Onwer cannot be null.")
	 * @Assert\Valid()
	 * @JMS\Exclude()
	 */
	private $owner;
	...
	/**
	 * @var ArrayCollection
	 * @ORM\OneToMany(targetEntity="iMSCP\ApsStandard\Entity\ApsInstanceSetting", mappedBy="instance", indexBy="name")
	 * @Assert\Valid()
	 ...
	 * @JMS\Type("string")
	 * @Assert\NotBlank(message="The '%s' field cannot be blank")
	 * @Assert\Choice(min="1", max="1", choices = {"toadd", "tochange", "todelete"}, message="Inval")
	 * @JMS\Groups("List")
	 */
	private $status;
