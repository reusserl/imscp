...
class ApsStandardListener implements ListenerAggregateInterface, ServiceLocatorAwareInterface
{
	...
	public function attach(EventManagerInterface $events)
	{
		...
		$this->listeners[] = $events->attach(
			Events::onBeforeDeleteCustomer, [$this, 'onDeleteDependentCustomer']
		);
		...
		if(PHP_SAPI == 'cli') {
			$this->listeners[] = $events->attach(
				Events::onBeforeCreateConsoleApplication, [$this, 'registerCommandLineToolCommands']
			);
		}
	}
...
#	}
	 ...
	 */
	public function registerCommandLineToolCommands(ConsoleEvent $event)
	{
