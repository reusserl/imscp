...
class TemplateEngine
{
    ...
    public function get_file($fname)
    {
        ...
        if ($this->is_safe($fname)) {
            ...
            $this->eventManager->dispatch(\iMSCP\Core\Events::onAfterLoadTemplateFile, [
                'context' => $this, 'templateContent' => $fileContent
            ]);
        ...
        $this->eventManager->dispatch(\iMSCP\Core\Events::onAfterAssembleTemplateFiles, [
            'context' => $this, 'templateContent' => $fileContent
        ]);
